...
export class ThreeUtils {
     ...
     *     })
     */
    static createLine2D(origin: Vector3, length: number, theta: number,
        lineStyle?: Partial<LineStyle>): Line {

        const line = ThreeUtils.createLine3D(
            origin,
     ...
     *          gapSize: 2}) )
     */
    static createLine3D(origin: Vector3, sphereCoords: Spherical,
        lineStyle: Partial<LineStyle> = {}): Line {
